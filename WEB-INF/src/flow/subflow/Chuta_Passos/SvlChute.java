...
public class SvlChute extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(SCESession mySession) {
		...
		try {
			...
			String valor = "293.02"; //valor da fatura
			String dataVencimento = "2022-02-14"; // data de vencimento da fatura
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			java.util.Date vencimento = sdf.parse(dataVencimento);
			LocalDate now = LocalDate.now();
		    Date hoje = java.sql.Date.valueOf(now);
			String xx = "";
			...
			int result = vencimento.compareTo(hoje);
...
//		System.out.println("retorno "+ retorno);
	 ...
	 *         Designer at: 8 DE FEVEREIRO DE 2022 13H59MIN13S BRT
	 */
