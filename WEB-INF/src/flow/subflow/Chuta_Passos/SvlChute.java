 ...
 */
public class SvlChute extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(SCESession mySession) {
		...
		String valor = "R$137,44";
		String vencimento = "15 de maio de 2022";
		String xx = "";
		...
		//venceu ou vai vencer?
		 
				try {
					SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
					java.util.Date date1 =  sdf.parse(ano + "-" + mesStr + "-" + dia); //vencimento
			        java.util.Date date2 = sdf.parse("2022-02-10"); //hoje
				...
				lista.add( fonoteca + "Chutepasso_Passo1_" + xx + "_a.wav");
				...
				lista.add(  fonoteca + "Chutepasso_Passo1_" + xx + "_b.wav");
				//data
		...
		lista.add(  fonoteca + "Chutepasso_Passo1_" + xx + "_c.wav");
...
//		System.out.println("retorno "+ retorno);
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("Chuta_Passos-DfnConcatenacao", 0, true, "Default");
		list.add(aGoto);
