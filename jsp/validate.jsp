...
<%!
	...
	static final String applicationName = "Concatenacoes";
	static final String applicationVersion = "1.0.0";	
	static final String entryPoint = "Concatenacoes/Start";
	static final String buildFrameworkVersion = "08.10.06.01";
	static final String buildFrameworkCommonVersion = "08.10.06.01";
	static final String ICCVersion = "08.10.06.01";
	static final String CTIVersion = "08.10.06.01";
